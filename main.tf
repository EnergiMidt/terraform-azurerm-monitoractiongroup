...
resource "azurerm_monitor_action_group" "monitor_action_group" {
  ...
  dynamic "azure_function_receiver" {
    ...
    content {
      name                     = azure_function_receiver.name
      function_app_resource_id = azure_function_receiver.function_app_resource_id
      function_name            = azure_function_receiver.function_name
      http_trigger_url         = azure_function_receiver.http_trigger_url
